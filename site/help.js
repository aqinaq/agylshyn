  ...
  kk: [
    ...
    },
    {
      ...
      list: [
        ...
        'Writing бетінде де сол түйме бар: екі тапсырмаға бір сағат, таймер мен «Тазалау» жабылады. Мұнда балл қойылмайды — соңында уақытың, сөз саның және критерийлер шығады.',
